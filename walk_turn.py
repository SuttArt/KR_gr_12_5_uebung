...
class Sprinter(Robot):
    ...
    def left(self, x, y, z, staby, yaw=0):

        # x, z 
        self.LKneePitch.setPosition ( z)
        self.LHipPitch.setPosition  (-z/2 + x + staby  - yaw)
        self.LAnklePitch.setPosition(-z/2 - x + yaw/4)
        ...
        # Left yaw
        self.LHipYawPitch.setPosition(yaw)

    
    
    # move the right foot (keep the foot paralell to the ground)
    def right(self, x, y, z, staby, yaw=0):

        # x, z
        self.RKneePitch.setPosition ( z)
        self.RHipPitch.setPosition  (-z/2 + x + staby - yaw)
        self.RAnklePitch.setPosition(-z/2 - x + yaw/4)
        ...
        # Right yaw
        self.RHipYawPitch.setPosition(yaw)
    ...
    def run(self, direction='forward'):
        ...
        while self.step(self.timeStep) != -1:
            ...
            if direction == 'forward':
                ...
                # apply
                self.left(  xLeft, yLeftRight, zLeft, -0.1, yaw)
                self.right(xRight, yLeftRight, zRight, -0.1, yaw)
            elif direction == 'walk_turn_right':               
                ## x
                # We do not want go forward
                xLeft = 0
                xRight = 0
...
controller.run(direction='walk_turn_right')